...
class RestaurantIntegrationTest {
    ...
    private List<RestaurantDto> registeredRestaurants = new ArrayList<>();
    ...
    class RegisterRestaurants {
        ...
        void test1() throws JsonProcessingException {
            // 기존 DB에 있는 값 넣기
            ResponseEntity<RestaurantDto[]> responseAll = restTemplate.getForEntity(
                "/restaurants",
                    RestaurantDto[].class
                );

            for(int i=0; i<responseAll.getBody().length; i++){
                registeredRestaurants.add(responseAll.getBody()[i]);
            }
        ...
        void test4() {
            ...
            System.out.println(responseRestaurants.length);
            System.out.println(responseRestaurants[0]);
